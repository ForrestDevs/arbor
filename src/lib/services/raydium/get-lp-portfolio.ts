...
export const getLpPortfolio = async (address: string): Promise<LpPortfolio> => {
  ...
  //   lpTokens
  //     .map((lpToken) => [
  //       lpToken.pool.mintA.address,
  //       lpToken.pool.mintB.address,
  //     ])
  //     .flat()
  // );
  ...
  //       async (tokenAddresses: string[]) => await getPrices(tokenAddresses)
  //     )
  //   )
  // ).reduce(
